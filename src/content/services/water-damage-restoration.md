...
priority: 9.0
plan_hash: "8109623906bd9ec1"
generated_at: "2026-07-28T14:44:41.869091+00:00"
manual_override: false
internal_links: ["/services/", "/contact/", "/service-areas/durham-nc/water-damage-restoration/", "/service-areas/middlesex-nc/water-damage-restoration/", "/service-areas/raleigh-nc/water-damage-restoration/", "/service-areas/rocky-mount-nc/water-damage-restoration/", "/service-areas/smithfield-nc/water-damage-restoration/", "/service-areas/wake-forest-nc/water-damage-restoration/", "/service-areas/wilson-nc/water-damage-restoration/", "/service-areas/zebulon-nc/water-damage-restoration/", "/blog/burst-pipe-emergency-checklist/", "/blog/what-to-do-first-24-hours-water-damage/", "/blog/choosing-a-restoration-company/"]
breadcrumb: [{"name": "Home", "url": "/"}, {"name": "Services", "url": "/services/"}, {"name": "Water Damage Restoration"}]
faq: [{"question": "Does homeowners insurance cover water damage restoration?", "answer": "Most standard homeowners policies cover sudden and accidental water losses \u2014 a burst pipe, a failed water heater, an appliance supply line that let go \u2014 but exclude gradual leaks, flooding from outside the structure, and maintenance-related failures. Go Green Restoration of NC works with all insurance carriers and handles the claim documentation, including the moisture mapping reports, drying logs, and material removal records that adjusters require to process a water damage claim."}, {"question": "How long does structural drying typically take after a water loss?", "answer": "A Category 1 (clean water) loss in a single room with no wet insulation typically reaches dry standard in three to five days under properly sized equipment. Category 2 losses with contaminated water, wet wall cavities, or saturated subfloor assemblies commonly run five to seven days. Category 3 losses require removal of affected porous materials before the drying clock even starts, so total project time extends accordingly. Daily moisture readings determine when drying is actually complete \u2014 a calendar estimate alone is not a reliable endpoint."}, {"question": "What is the difference between water extraction and structural drying, and do I need both?", "answer": "Water extraction removes standing and pooled water \u2014 the bulk volume you can see and pump out. Structural drying addresses the moisture that has already been absorbed into materials: drywall, framing, subfloor, insulation, and concrete. After extraction, affected materials can still hold enough moisture to sustain mold growth and cause structural swelling. Both steps are necessary; extraction without drying leaves a wet structure, and attempting to dry without thorough extraction significantly extends the drying window and equipment cost."}, {"question": "What should I do \u2014 and not do \u2014 while waiting for the restoration crew to arrive?", "answer": "Stop the water source if you can safely do so, and turn off electricity to affected areas if there is any risk of water contact with outlets or panels. Remove small valuables and documents from the wet area. Do not run a household fan into wet wall cavities \u2014 it can push moisture deeper into the assembly and, with Category 2 or 3 water, spread contaminants. Avoid walking through standing water if the source is a drain backup or toilet overflow. Leave wet carpet and flooring in place; the restoration crew needs to assess moisture content before deciding what can be dried versus removed."}, {"question": "How do technicians know when a structure is actually dry, and what documentation proves it?", "answer": "Drying is verified using calibrated moisture meters and thermo-hygrometers that measure moisture content in specific materials (wood framing, drywall, subfloor) against a dry standard established for that material type and the ambient conditions in the region. Readings are logged daily on a psychrometric drying report that records temperature, relative humidity, specific humidity, and material moisture content at each monitoring point. That report is the document your insurance carrier uses to confirm that drying was complete and that the scope of removed materials was justified \u2014 it is not optional paperwork."}]
...
|---|---|
| Single room, clean water (Cat 1), no material removal | $1,200 – $3,500 |
| Single room, Cat 2, carpet and pad removal | $2,500 – $5,500 |
| Basement, clean water, concrete slab | $2,000 – $6,000 |
| Multi-room loss, Cat 2/3, drywall removal | $5,000 – $15,000 |
| Crawl space water intrusion with insulation removal | $3,000 – $8,000 |
| Whole-floor loss, Cat 3 / sewage backup | $8,000 – $25,000+ |
