...
generated_at: "2026-07-28T14:49:21.042078+00:00"
...
faq: [{"question": "How quickly does mold actually start growing after a water leak?", "answer": "Under warm, humid conditions \u2014 common in central North Carolina from late spring through early fall \u2014 mold can begin colonizing porous materials like drywall, insulation, and wood framing within 24 to 48 hours of sustained moisture exposure. That timeline shortens if the affected area has poor airflow or if there was pre-existing mold present. This is why water damage that looks minor on the surface can still warrant professional drying: the goal is to get materials below the moisture threshold before colonization begins, not to clean up mold after the fact."}, {"question": "Can I handle a small mold patch myself, or do I always need a professional?", "answer": "The EPA's general guidance is that areas smaller than 10 square feet \u2014 roughly a 3-by-3-foot patch \u2014 can be addressed by a careful homeowner using appropriate PPE (N95 respirator, gloves, eye protection) and an EPA-registered antimicrobial cleaner. The more important question is whether you've identified and fixed the moisture source, because surface cleaning without addressing the underlying cause will result in regrowth. For anything larger, for mold inside HVAC systems, or for households with immunocompromised occupants, professional remediation is the safer path."}, {"question": "What happens if I file an insurance claim and the restoration company's estimate is higher than what my adjuster approves?", "answer": "This is common, and it doesn't have to be a standoff. A restoration company experienced with insurance claims can provide supplemental documentation \u2014 additional moisture logs, photos, or line-item justifications \u2014 to support a revised estimate. You also have the right to hire a public adjuster to advocate on your behalf, independent of both the carrier and the restoration contractor. What you want to avoid is authorizing work beyond your approved amount without a clear written agreement about who is responsible for the difference."}, {"question": "Is a contractor who specializes in restoration actually different from a general contractor?", "answer": "Yes, in meaningful ways. Restoration work involves drying science, industrial hygiene, and insurance documentation that general construction doesn't. An IICRC-certified water damage technician, for example, is trained to read psychrometric data and make drying decisions based on material type and ambient conditions \u2014 skills a general remodeler typically doesn't have. That said, restoration companies often subcontract the rebuild phase (drywall, flooring, painting) to general contractors, so the two disciplines frequently overlap on the same job. The key is making sure the remediation and drying phases are handled by someone with the right technical background before the reconstruction begins."}]
...
Even after you've hired someone, stay engaged. Here's what to watch for once work begins:
...
Some situations don't allow for extended research:

- Standing water that has been present for more than 24 hours (mold can begin colonizing porous materials within 24–48 hours under the right temperature and humidity conditions)
- Any water intrusion that may have contacted the electrical system
- Visible mold covering more than 10 square feet (the EPA threshold above which professional remediation is recommended)
